...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 558;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 293;
    ...
    //  DONE (5) Add a static method called
